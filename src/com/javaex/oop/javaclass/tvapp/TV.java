...
public class TV {
	...
	public void status() {
		if (power) {
			System.out.println("Power: on, Channel:" +
								channel + ", Volume:" +
								volume);
		} else {
	...
	//	전원 메서드: true면 on, false면 off
	public void power(boolean power) {
		this.power = power;
	}
	
	//	채널 메서드: 숫자가 입력되면 직접 세팅, 단 범위 내에서만...
	...
	//	채널 메서드: true면 up, false면 down (오버로딩)
	...
	//	볼륨 메서드 : true면 볼륨 up, false면 down (오버로딩)
